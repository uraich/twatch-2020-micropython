...
STATIC inline LodePNGDecompressSettings* mp_write_ptr_LodePNGDecompressSettings(mp_obj_t self_in)
{
    mp_lv_struct_t *self = MP_OBJ_TO_PTR(cast(self_in, get_mp_LodePNGDecompressSettings_type()));
    return (LodePNGDecompressSettings*)self->data;
}

#define mp_write_LodePNGDecompressSettings(struct_obj) *mp_write_ptr_LodePNGDecompressSettings(struct_obj)

STATIC inline mp_obj_t mp_read_ptr_LodePNGDecompressSettings(LodePNGDecompressSettings *field)
{
    return lv_to_mp_struct(get_mp_LodePNGDecompressSettings_type(), (void*)field);
}

#define mp_read_LodePNGDecompressSettings(field) mp_read_ptr_LodePNGDecompressSettings(copy_buffer(&field, sizeof(LodePNGDecompressSettings)))
...
{
    mp_lv_struct_t *self = MP_OBJ_TO_PTR(self_in);
    LodePNGDecompressSettings *data = (LodePNGDecompressSettings*)self->data;
...
STATIC const mp_rom_map_elem_t mp_LodePNGDecompressSettings_locals_dict_table[] = {
    { MP_ROM_QSTR(MP_QSTR_SIZE), MP_ROM_PTR(MP_ROM_INT(sizeof(LodePNGDecompressSettings))) },
    { MP_ROM_QSTR(MP_QSTR_cast), MP_ROM_PTR(&mp_lv_cast_class_method) },
    { MP_ROM_QSTR(MP_QSTR_cast_instance), MP_ROM_PTR(&mp_lv_cast_instance_obj) },
    { MP_ROM_QSTR(MP_QSTR___dereference__), MP_ROM_PTR(&mp_lv_dereference_obj) },

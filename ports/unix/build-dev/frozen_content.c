...
const qstr_pool_t mp_qstr_frozen_const_pool = {
    ...
    163, // used entries
    {
        ...
        (const byte*)"\xdd\x5d\x07" "handler",
        ...
        (const byte*)"\x3e\x54\x07" "timeout",
...
STATIC byte fun_data_uasyncio___init____lt_module_gt____getattr__[63] = {
    0x49, 0x0a,
    ...
    0x00,
    0x12, MP_QSTR__attrs & 0xff, MP_QSTR__attrs >> 8,  0x00,
    0x14, MP_QSTR_get & 0xff, MP_QSTR_get >> 8, 
    0xb0, 
    0x51, 
    0x36, 0x02, 
    ...
    0xde, 
    0x44, 0x08, 0x80, 
    0x12, MP_QSTR_AttributeError & 0xff, MP_QSTR_AttributeError >> 8,  0x00,
    0xb0, 
    0x34, 0x01, 
    0x65, 
    0x12, MP_QSTR_getattr & 0xff, MP_QSTR_getattr >> 8,  0x00,
    0x12, MP_QSTR___import__ & 0xff, MP_QSTR___import__ >> 8,  0x00,
    0xb1, 
    0x51, 
    0x51, 
    0x52, 
    ...
    0xc2, 
    0xb2, 
    0x12, MP_QSTR_globals & 0xff, MP_QSTR_globals >> 8,  0x00,
    0x34, 0x00, 
    0xb0, 
    0x56, 
    0xb2, 
...
STATIC byte fun_data_uasyncio___init____lt_module_gt_[95] = {
    0x10, 0x0a,
    MP_QSTR__lt_module_gt_ & 0xff, MP_QSTR__lt_module_gt_ >> 8,
    MP_QSTR_uasyncio_slash___init___dot_py & 0xff, MP_QSTR_uasyncio_slash___init___dot_py >> 8,
    0x00,
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__CancelledError[22] = {
    0x00, 0x0a,
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__TimeoutError[22] = {
    0x00, 0x0a,
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__SingletonGenerator___init__[26] = {
    0x11, 0x0a,
    MP_QSTR___init__ & 0xff, MP_QSTR___init__ >> 8,
    MP_QSTR_uasyncio_slash_core_dot_py & 0xff, MP_QSTR_uasyncio_slash_core_dot_py >> 8,
    0x00,
    0x51, 
    0xb0, 
    0x18, MP_QSTR_state & 0xff, MP_QSTR_state >> 8,  0x00,
    0x12, MP_QSTR_StopIteration & 0xff, MP_QSTR_StopIteration >> 8,  0x00,
    0x34, 0x00, 
    0xb0, 
    0x18, MP_QSTR_exc & 0xff, MP_QSTR_exc >> 8,  0x00,
    0x51, 
    0x63, 
};
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__SingletonGenerator___iter__[9] = {
    0x09, 0x0a,
    MP_QSTR___iter__ & 0xff, MP_QSTR___iter__ >> 8,
    MP_QSTR_uasyncio_slash_core_dot_py & 0xff, MP_QSTR_uasyncio_slash_core_dot_py >> 8,
    0x00,
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__SingletonGenerator___next__[63] = {
    0x21, 0x0a,
    MP_QSTR___next__ & 0xff, MP_QSTR___next__ >> 8,
    MP_QSTR_uasyncio_slash_core_dot_py & 0xff, MP_QSTR_uasyncio_slash_core_dot_py >> 8,
    0x00,
    0xb0, 
    0x13, MP_QSTR_state & 0xff, MP_QSTR_state >> 8,  0x00,
    0x51, 
    0xde, 
    0xd3, 
    0x44, 0x1b, 0x80, 
    0x12, MP_QSTR__task_queue & 0xff, MP_QSTR__task_queue >> 8,  0x00,
    0x14, MP_QSTR_push_sorted & 0xff, MP_QSTR_push_sorted >> 8, 
    0x12, MP_QSTR_cur_task & 0xff, MP_QSTR_cur_task >> 8,  0x00,
    0xb0, 
    0x13, MP_QSTR_state & 0xff, MP_QSTR_state >> 8,  0x00,
    0x36, 0x02, 
    0x59, 
    ...
    0x51, 
    0xb0, 
    0x13, MP_QSTR_exc & 0xff, MP_QSTR_exc >> 8,  0x00,
    0x18, MP_QSTR___traceback__ & 0xff, MP_QSTR___traceback__ >> 8,  0x00,
    0xb0, 
    0x13, MP_QSTR_exc & 0xff, MP_QSTR_exc >> 8,  0x00,
    0x65, 
    0x51, 
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__SingletonGenerator[37] = {
    0x00, 0x0a,
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__sleep_ms[35] = {
    0xb2, 0x01, 0x0a,
    MP_QSTR_sleep_ms & 0xff, MP_QSTR_sleep_ms >> 8,
    MP_QSTR_uasyncio_slash_core_dot_py & 0xff, MP_QSTR_uasyncio_slash_core_dot_py >> 8,
    0x00,
    0x12, MP_QSTR_ticks_add & 0xff, MP_QSTR_ticks_add >> 8,  0x00,
    0x12, MP_QSTR_ticks & 0xff, MP_QSTR_ticks >> 8,  0x00,
    0x34, 0x00, 
    0x12, MP_QSTR_max & 0xff, MP_QSTR_max >> 8,  0x00,
    0x80, 
    0xb0, 
    0x34, 0x02, 
    0x34, 0x02, 
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__sleep[25] = {
    0x21, 0x0a,
    MP_QSTR_sleep & 0xff, MP_QSTR_sleep >> 8,
    MP_QSTR_uasyncio_slash_core_dot_py & 0xff, MP_QSTR_uasyncio_slash_core_dot_py >> 8,
    0x00,
    0x12, MP_QSTR_sleep_ms & 0xff, MP_QSTR_sleep_ms >> 8,  0x00,
    0x12, MP_QSTR_int & 0xff, MP_QSTR_int >> 8,  0x00,
    0xb0, 
    0x22, 0x87, 0x68, 
    0xf4, 
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__IOQueue___init__[30] = {
    0x11, 0x0a,
    MP_QSTR___init__ & 0xff, MP_QSTR___init__ >> 8,
    MP_QSTR_uasyncio_slash_core_dot_py & 0xff, MP_QSTR_uasyncio_slash_core_dot_py >> 8,
    0x00,
    0x12, MP_QSTR_select & 0xff, MP_QSTR_select >> 8,  0x00,
    0x14, MP_QSTR_poll & 0xff, MP_QSTR_poll >> 8, 
    0x36, 0x00, 
    0xb0, 
    0x18, MP_QSTR_poller & 0xff, MP_QSTR_poller >> 8,  0x00,
    0x2c, 0x00, 
    0xb0, 
    0x18, MP_QSTR_map & 0xff, MP_QSTR_map >> 8,  0x00,
    0x51, 
    0x63, 
};
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__IOQueue__enqueue[152] = {
    0x4b, 0x0a,
    MP_QSTR__enqueue & 0xff, MP_QSTR__enqueue >> 8,
    MP_QSTR_uasyncio_slash_core_dot_py & 0xff, MP_QSTR_uasyncio_slash_core_dot_py >> 8,
    0x00,
    0x12, MP_QSTR_id & 0xff, MP_QSTR_id >> 8,  0x00,
    0xb1, 
    0x34, 0x01, 
    0xb0, 
    0x13, MP_QSTR_map & 0xff, MP_QSTR_map >> 8,  0x00,
    0xdd, 
    0xd3, 
    0x44, 0x43, 0x80, 
    0x51, 
    ...
    0x56, 
    0xb0, 
    0x13, MP_QSTR_poller & 0xff, MP_QSTR_poller >> 8,  0x00,
    ...
    0x44, 0x0b, 0x80, 
    0x12, MP_QSTR_select & 0xff, MP_QSTR_select >> 8,  0x00,
    0x13, MP_QSTR_POLLIN & 0xff, MP_QSTR_POLLIN >> 8,  0x00,
    0x42, 0x08, 0x80, 
    0x12, MP_QSTR_select & 0xff, MP_QSTR_select >> 8,  0x00,
    0x13, MP_QSTR_POLLOUT & 0xff, MP_QSTR_POLLOUT >> 8,  0x00,
    0x36, 0x02, 
    0x59, 
    0x42, 0x32, 0x80, 
    0xb0, 
    ...
    0xb0, 
    0x12, MP_QSTR_cur_task & 0xff, MP_QSTR_cur_task >> 8,  0x00,
    0x18, MP_QSTR_data & 0xff, MP_QSTR_data >> 8,  0x00,
    0x51, 
    0x63, 
};
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__IOQueue__dequeue[36] = {
    0x22, 0x0a,
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__IOQueue_queue_read[18] = {
    0x2a, 0x0a,
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__IOQueue_queue_write[18] = {
    0x2a, 0x0a,
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__IOQueue_remove[81] = {
    0x6a, 0x0a,
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__IOQueue_wait_io_event[203] = {
    0x62, 0x0a,
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__IOQueue[57] = {
    0x00, 0x0a,
...
STATIC byte fun_data_uasyncio_core__lt_module_gt___promote_to_task[31] = {
    0x19, 0x0a,
    ...
    0x12, MP_QSTR_isinstance & 0xff, MP_QSTR_isinstance >> 8,  0x00,
    0xb0, 
    0x12, MP_QSTR_Task & 0xff, MP_QSTR_Task >> 8,  0x00,
    0x34, 0x02, 
    0x44, 0x02, 0x80, 
    0xb0, 
    0x63, 
    0x12, MP_QSTR_create_task & 0xff, MP_QSTR_create_task >> 8,  0x00,
    0xb0, 
    0x34, 0x01, 
    0x63, 
};
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__create_task[56] = {
    0x21, 0x0a,
    MP_QSTR_create_task & 0xff, MP_QSTR_create_task >> 8,
    MP_QSTR_uasyncio_slash_core_dot_py & 0xff, MP_QSTR_uasyncio_slash_core_dot_py >> 8,
    0x00,
    0x12, MP_QSTR_hasattr & 0xff, MP_QSTR_hasattr >> 8,  0x00,
    0xb0, 
    0x10, MP_QSTR_send & 0xff, MP_QSTR_send >> 8, 
    0x34, 0x02, 
    0x43, 0x09, 0x80, 
    0x12, MP_QSTR_TypeError & 0xff, MP_QSTR_TypeError >> 8,  0x00,
    0x23, 0x01, 
    0x34, 0x01, 
    0x65, 
    0x12, MP_QSTR_Task & 0xff, MP_QSTR_Task >> 8,  0x00,
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__run_until_complete[322] = {
    0xf1, 0x03, 0x0a,
    MP_QSTR_run_until_complete & 0xff, MP_QSTR_run_until_complete >> 8,
    MP_QSTR_uasyncio_slash_core_dot_py & 0xff, MP_QSTR_uasyncio_slash_core_dot_py >> 8,
    0x00,
    0x12, MP_QSTR_CancelledError & 0xff, MP_QSTR_CancelledError >> 8,  0x00,
    0x12, MP_QSTR_Exception & 0xff, MP_QSTR_Exception >> 8,  0x00,
    0x2a, 0x02, 
    0xc1, 
    0x12, MP_QSTR_CancelledError & 0xff, MP_QSTR_CancelledError >> 8,  0x00,
    ...
    0x12, MP_QSTR_max & 0xff, MP_QSTR_max >> 8,  0x00,
    0x80, 
    0x12, MP_QSTR_ticks_diff & 0xff, MP_QSTR_ticks_diff >> 8,  0x00,
    0xb4, 
    0x13, MP_QSTR_ph_key & 0xff, MP_QSTR_ph_key >> 8,  0x00,
    0x12, MP_QSTR_ticks & 0xff, MP_QSTR_ticks >> 8,  0x00,
    0x34, 0x00, 
    0x34, 0x02, 
    0x34, 0x02, 
    0xc3, 
    0x42, 0x0d, 0x80, 
    0x12, MP_QSTR__io_queue & 0xff, MP_QSTR__io_queue >> 8,  0x00,
    0x13, MP_QSTR_map & 0xff, MP_QSTR_map >> 8,  0x00,
    0x43, 0x02, 0x80, 
    0x51, 
    0x63, 
    ...
    0x48, 0x2e, 0x00, 
    0xb4, 
    0x13, MP_QSTR_data & 0xff, MP_QSTR_data >> 8,  0x00,
    0xc5, 
    0xb5, 
    0x43, 0x0f, 0x80, 
    0xb4, 
    0x13, MP_QSTR_coro & 0xff, MP_QSTR_coro >> 8,  0x00,
    ...
    0x44, 0x06, 0x80, 
    0xb6, 
    0x13, MP_QSTR_value & 0xff, MP_QSTR_value >> 8,  0x00,
    0x63, 
    0xb6, 
    0x65, 
    0x50, 
    ...
    0x14, MP_QSTR_push_head & 0xff, MP_QSTR_push_head >> 8, 
    0xb4, 
    0x13, MP_QSTR_waiting & 0xff, MP_QSTR_waiting >> 8,  0x00,
    0x14, MP_QSTR_pop_head & 0xff, MP_QSTR_pop_head >> 8, 
    0x36, 0x00, 
    0x36, 0x01, 
    0x59, 
    ...
    0x51, 
    0xb4, 
    0x18, MP_QSTR_waiting & 0xff, MP_QSTR_waiting >> 8,  0x00,
    0xb7, 
    0x43, 0x16, 0x80, 
    0x12, MP_QSTR_isinstance & 0xff, MP_QSTR_isinstance >> 8,  0x00,
    0xb6, 
    ...
    0xb4, 
    0xb4, 
    0x18, MP_QSTR_coro & 0xff, MP_QSTR_coro >> 8,  0x00,
    0xb6, 
    0xb4, 
    0x18, MP_QSTR_data & 0xff, MP_QSTR_data >> 8,  0x00,
    0x51, 
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__run[21] = {
    0x19, 0x0a,
    MP_QSTR_run & 0xff, MP_QSTR_run >> 8,
    MP_QSTR_uasyncio_slash_core_dot_py & 0xff, MP_QSTR_uasyncio_slash_core_dot_py >> 8,
    0x00,
    0x12, MP_QSTR_run_until_complete & 0xff, MP_QSTR_run_until_complete >> 8,  0x00,
    0x12, MP_QSTR_create_task & 0xff, MP_QSTR_create_task >> 8,  0x00,
    0xb0, 
    0x34, 0x01, 
    0x34, 0x01, 
...
STATIC byte fun_data_uasyncio_core__lt_module_gt___stopper[10] = {
    0x80, 0x40, 0x0a,
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__Loop_create_task[15] = {
    0x11, 0x0a,
    MP_QSTR_create_task & 0xff, MP_QSTR_create_task >> 8,
    MP_QSTR_uasyncio_slash_core_dot_py & 0xff, MP_QSTR_uasyncio_slash_core_dot_py >> 8,
    0x00,
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__Loop_run_forever[41] = {
    0x10, 0x0a,
    MP_QSTR_run_forever & 0xff, MP_QSTR_run_forever >> 8,
    MP_QSTR_uasyncio_slash_core_dot_py & 0xff, MP_QSTR_uasyncio_slash_core_dot_py >> 8,
    0x00,
    0x12, MP_QSTR_Task & 0xff, MP_QSTR_Task >> 8,  0x00,
    0x12, MP_QSTR__stopper & 0xff, MP_QSTR__stopper >> 8,  0x00,
    0x34, 0x00, 
    0x12, MP_QSTR_globals & 0xff, MP_QSTR_globals >> 8,  0x00,
    0x34, 0x00, 
    0x34, 0x02, 
    ...
    0x12, MP_QSTR_run_until_complete & 0xff, MP_QSTR_run_until_complete >> 8,  0x00,
    0x12, MP_QSTR__stop_task & 0xff, MP_QSTR__stop_task >> 8,  0x00,
    0x34, 0x01, 
    0x59, 
    0x51, 
    0x63, 
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__Loop_run_until_complete[21] = {
    0x19, 0x0a,
    MP_QSTR_run_until_complete & 0xff, MP_QSTR_run_until_complete >> 8,
    MP_QSTR_uasyncio_slash_core_dot_py & 0xff, MP_QSTR_uasyncio_slash_core_dot_py >> 8,
    0x00,
    0x12, MP_QSTR_run_until_complete & 0xff, MP_QSTR_run_until_complete >> 8,  0x00,
    0x12, MP_QSTR__promote_to_task & 0xff, MP_QSTR__promote_to_task >> 8,  0x00,
    0xb0, 
    0x34, 0x01, 
    0x34, 0x01, 
    0x63, 
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__Loop_stop[37] = {
    0x10, 0x0a,
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__Loop_close[9] = {
    0x00, 0x0a,
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__Loop_set_exception_handler[18] = {
    0x11, 0x0a,
    MP_QSTR_set_exception_handler & 0xff, MP_QSTR_set_exception_handler >> 8,
    MP_QSTR_uasyncio_slash_core_dot_py & 0xff, MP_QSTR_uasyncio_slash_core_dot_py >> 8,
    0x00,
    0xb0, 
    0x12, MP_QSTR_Loop & 0xff, MP_QSTR_Loop >> 8,  0x00,
    0x18, MP_QSTR__exc_handler & 0xff, MP_QSTR__exc_handler >> 8,  0x00,
    0x51, 
    0x63, 
};
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__Loop_get_exception_handler[16] = {
    0x00, 0x0a,
    MP_QSTR_get_exception_handler & 0xff, MP_QSTR_get_exception_handler >> 8,
    MP_QSTR_uasyncio_slash_core_dot_py & 0xff, MP_QSTR_uasyncio_slash_core_dot_py >> 8,
    0x00,
    0x12, MP_QSTR_Loop & 0xff, MP_QSTR_Loop >> 8,  0x00,
    0x13, MP_QSTR__exc_handler & 0xff, MP_QSTR__exc_handler >> 8,  0x00,
    0x63, 
};
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__Loop_default_exception_handler[63] = {
    0x3a, 0x0a,
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__Loop_call_exception_handler[36] = {
    0x19, 0x0a,
    ...
    0x45, 0x08, 0x80, 
    0x12, MP_QSTR_Loop & 0xff, MP_QSTR_Loop >> 8,  0x00,
    0x13, MP_QSTR_default_exception_handler & 0xff, MP_QSTR_default_exception_handler >> 8,  0x00,
    0x12, MP_QSTR_Loop & 0xff, MP_QSTR_Loop >> 8,  0x00,
    0xb0, 
    0x34, 0x02, 
    0x59, 
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__Loop[71] = {
    0x00, 0x0a,
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__get_event_loop[14] = {
    0x92, 0x80, 0x01, 0x0a,
...
STATIC byte fun_data_uasyncio_core__lt_module_gt__new_event_loop[30] = {
    0x00, 0x0a,
    MP_QSTR_new_event_loop & 0xff, MP_QSTR_new_event_loop >> 8,
    MP_QSTR_uasyncio_slash_core_dot_py & 0xff, MP_QSTR_uasyncio_slash_core_dot_py >> 8,
    0x00,
    0x12, MP_QSTR_TaskQueue & 0xff, MP_QSTR_TaskQueue >> 8,  0x00,
    0x34, 0x00, 
    0x17, MP_QSTR__task_queue & 0xff, MP_QSTR__task_queue >> 8, 
    0x12, MP_QSTR_IOQueue & 0xff, MP_QSTR_IOQueue >> 8,  0x00,
    0x34, 0x00, 
...
STATIC byte fun_data_uasyncio_core__lt_module_gt_[278] = {
    0x2c, 0x0a,
    MP_QSTR__lt_module_gt_ & 0xff, MP_QSTR__lt_module_gt_ >> 8,
    MP_QSTR_uasyncio_slash_core_dot_py & 0xff, MP_QSTR_uasyncio_slash_core_dot_py >> 8,
    0x00,
    ...
    0x32, 0x01, 
    0x10, MP_QSTR_CancelledError & 0xff, MP_QSTR_CancelledError >> 8, 
    0x11, MP_QSTR_BaseException & 0xff, MP_QSTR_BaseException >> 8,  0x00,
    0x34, 0x03, 
    ...
    0x11, MP_QSTR_SingletonGenerator & 0xff, MP_QSTR_SingletonGenerator >> 8,  0x00,
    0x34, 0x00, 
    0x2a, 0x01, 
    0x53, 
    0x33, 0x04, 
    ...
    0x11, MP_QSTR_new_event_loop & 0xff, MP_QSTR_new_event_loop >> 8,  0x00,
    0x34, 0x00, 
    0x59, 
    0x51, 
    0x63, 
...
STATIC byte fun_data_uasyncio_event__lt_module_gt__Event___init__[29] = {
    0x11, 0x0a,
    MP_QSTR___init__ & 0xff, MP_QSTR___init__ >> 8,
    ...
    0xb0, 
    0x18, MP_QSTR_state & 0xff, MP_QSTR_state >> 8,  0x00,
    0x12, MP_QSTR_core & 0xff, MP_QSTR_core >> 8,  0x00,
...
STATIC byte fun_data_uasyncio_event__lt_module_gt__Event_is_set[13] = {
    0x09, 0x0a,
...
STATIC byte fun_data_uasyncio_event__lt_module_gt__Event_set[55] = {
    0x21, 0x0a,
    ...
    0x42, 0x18, 0x80, 
    0x12, MP_QSTR_core & 0xff, MP_QSTR_core >> 8,  0x00,
    0x13, MP_QSTR__task_queue & 0xff, MP_QSTR__task_queue >> 8,  0x00,
    0x14, MP_QSTR_push_head & 0xff, MP_QSTR_push_head >> 8, 
    0xb0, 
    0x13, MP_QSTR_waiting & 0xff, MP_QSTR_waiting >> 8,  0x00,
    0x14, MP_QSTR_pop_head & 0xff, MP_QSTR_pop_head >> 8, 
...
STATIC byte fun_data_uasyncio_event__lt_module_gt__Event_clear[15] = {
    0x11, 0x0a,
...
STATIC byte fun_data_uasyncio_event__lt_module_gt__Event_wait[57] = {
    0x99, 0x40, 0x0a,
    ...
    0x14, MP_QSTR_push_head & 0xff, MP_QSTR_push_head >> 8, 
    0x12, MP_QSTR_core & 0xff, MP_QSTR_core >> 8,  0x00,
    0x13, MP_QSTR_cur_task & 0xff, MP_QSTR_cur_task >> 8,  0x00,
    0x36, 0x01, 
    0x59, 
    0xb0, 
    0x13, MP_QSTR_waiting & 0xff, MP_QSTR_waiting >> 8,  0x00,
...
STATIC byte fun_data_uasyncio_event__lt_module_gt__Event[47] = {
    0x00, 0x0a,
...
STATIC byte fun_data_uasyncio_event__lt_module_gt_[36] = {
    0x10, 0x0a,
    MP_QSTR__lt_module_gt_ & 0xff, MP_QSTR__lt_module_gt_ >> 8,
    MP_QSTR_uasyncio_slash_event_dot_py & 0xff, MP_QSTR_uasyncio_slash_event_dot_py >> 8,
    0x00,
...
STATIC byte fun_data_uasyncio_funcs__lt_module_gt__wait_for_runner[66] = {
    0xd8, 0x46, 0x0a,
    ...
    0x4a, 0x19, 0x00, 
    0x57, 
    0x12, MP_QSTR_BaseException & 0xff, MP_QSTR_BaseException >> 8,  0x00,
    0xdf, 
    0x44, 0x0f, 0x80, 
    0xc5, 
    0x49, 0x03, 0x00, 
...
STATIC byte fun_data_uasyncio_funcs__lt_module_gt__wait_for[169] = {
    0xeb, 0x43, 0x8a, 0x01,
    ...
    0x57, 
    0x12, MP_QSTR_core & 0xff, MP_QSTR_core >> 8,  0x00,
    0x13, MP_QSTR_CancelledError & 0xff, MP_QSTR_CancelledError >> 8,  0x00,
    0xdf, 
    0x44, 0x30, 0x80, 
    0xc5, 
    0x49, 0x24, 0x00, 
    ...
    0x59, 
    0x12, MP_QSTR_core & 0xff, MP_QSTR_core >> 8,  0x00,
    0x13, MP_QSTR_TimeoutError & 0xff, MP_QSTR_TimeoutError >> 8,  0x00,
    0x65, 
    0x51, 
    0x63, 
};
...
STATIC byte fun_data_uasyncio_funcs__lt_module_gt__wait_for_ms[24] = {
    0x2a, 0x0a,
    MP_QSTR_wait_for_ms & 0xff, MP_QSTR_wait_for_ms >> 8,
    MP_QSTR_uasyncio_slash_funcs_dot_py & 0xff, MP_QSTR_uasyncio_slash_funcs_dot_py >> 8,
    0x00,
    0x12, MP_QSTR_wait_for & 0xff, MP_QSTR_wait_for >> 8,  0x00,
    0xb0, 
    0xb1, 
    0x12, MP_QSTR_core & 0xff, MP_QSTR_core >> 8,  0x00,
    0x13, MP_QSTR_sleep_ms & 0xff, MP_QSTR_sleep_ms >> 8,  0x00,
    0x34, 0x03, 
    0x63, 
};
...
STATIC byte fun_data_uasyncio_funcs__lt_module_gt__gather__lt_listcomp_gt_[31] = {
    0x49, 0x0a,
...
STATIC byte fun_data_uasyncio_funcs__lt_module_gt__gather[93] = {
...
STATIC byte fun_data_uasyncio_funcs__lt_module_gt_[59] = {
    0x18, 0x0a,
    MP_QSTR__lt_module_gt_ & 0xff, MP_QSTR__lt_module_gt_ >> 8,
    MP_QSTR_uasyncio_slash_funcs_dot_py & 0xff, MP_QSTR_uasyncio_slash_funcs_dot_py >> 8,
    0x00,
    ...
    0x16, MP_QSTR_core & 0xff, MP_QSTR_core >> 8, 
    0x59, 
    0x11, MP_QSTR_core & 0xff, MP_QSTR_core >> 8,  0x00,
    0x13, MP_QSTR_sleep & 0xff, MP_QSTR_sleep >> 8,  0x00,
    0x2a, 0x01, 
    0x53, 
    0x33, 0x00, 
...
STATIC byte fun_data_uasyncio_lock__lt_module_gt__Lock___init__[29] = {
    0x11, 0x0a,
    MP_QSTR___init__ & 0xff, MP_QSTR___init__ >> 8,
...
STATIC byte fun_data_uasyncio_lock__lt_module_gt__Lock_locked[15] = {
    0x11, 0x0a,
...
STATIC byte fun_data_uasyncio_lock__lt_module_gt__Lock_release[84] = {
    0x19, 0x0a,
    ...
    0xdc, 
    0x44, 0x09, 0x80, 
    0x12, MP_QSTR_RuntimeError & 0xff, MP_QSTR_RuntimeError >> 8,  0x00,
    0x23, 0x01, 
    0x34, 0x01, 
    0x65, 
    0xb0, 
...
STATIC byte fun_data_uasyncio_lock__lt_module_gt__Lock_acquire[130] = {
    0xb9, 0x42, 0x0a,
...
STATIC byte fun_data_uasyncio_lock__lt_module_gt__Lock___aenter__[18] = {
    0x91, 0x40, 0x0a,
...
STATIC byte fun_data_uasyncio_lock__lt_module_gt__Lock___aexit__[15] = {
    0xa8, 0x44, 0x0a,
...
STATIC byte fun_data_uasyncio_lock__lt_module_gt__Lock[52] = {
    0x00, 0x0a,
...
STATIC byte fun_data_uasyncio_lock__lt_module_gt_[36] = {
    0x10, 0x0a,
    MP_QSTR__lt_module_gt_ & 0xff, MP_QSTR__lt_module_gt_ >> 8,
    MP_QSTR_uasyncio_slash_lock_dot_py & 0xff, MP_QSTR_uasyncio_slash_lock_dot_py >> 8,
    0x00,
...
STATIC byte fun_data_uasyncio_stream__lt_module_gt__Stream___init__[29] = {
    0xa3, 0x01, 0x0a,
    MP_QSTR___init__ & 0xff, MP_QSTR___init__ >> 8,
    ...
    0xb1, 
    0xb0, 
    0x18, MP_QSTR_s & 0xff, MP_QSTR_s >> 8,  0x00,
    0xb2, 
    0xb0, 
    0x18, MP_QSTR_e & 0xff, MP_QSTR_e >> 8,  0x00,
    0x23, 0x03, 
    0xb0, 
    0x18, MP_QSTR_out_buf & 0xff, MP_QSTR_out_buf >> 8,  0x00,
    0x51, 
    0x63, 
};
...
STATIC byte fun_data_uasyncio_stream__lt_module_gt__Stream_get_extra_info[15] = {
    0x1a, 0x0a,
    MP_QSTR_get_extra_info & 0xff, MP_QSTR_get_extra_info >> 8,
    MP_QSTR_uasyncio_slash_stream_dot_py & 0xff, MP_QSTR_uasyncio_slash_stream_dot_py >> 8,
    0x00,
    0xb0, 
    0x13, MP_QSTR_e & 0xff, MP_QSTR_e >> 8,  0x00,
    0xb1, 
    0x55, 
    0x63, 
};
...
STATIC byte fun_data_uasyncio_stream__lt_module_gt__Stream___aenter__[10] = {
    0x89, 0x40, 0x0a,
    MP_QSTR___aenter__ & 0xff, MP_QSTR___aenter__ >> 8,
    MP_QSTR_uasyncio_slash_stream_dot_py & 0xff, MP_QSTR_uasyncio_slash_stream_dot_py >> 8,
    0x00,
...
STATIC byte fun_data_uasyncio_stream__lt_module_gt__Stream___aexit__[20] = {
    0xa8, 0x44, 0x0a,
    MP_QSTR___aexit__ & 0xff, MP_QSTR___aexit__ >> 8,
    MP_QSTR_uasyncio_slash_stream_dot_py & 0xff, MP_QSTR_uasyncio_slash_stream_dot_py >> 8,
    0x00,
...
STATIC byte fun_data_uasyncio_stream__lt_module_gt__Stream_close[9] = {
    0x09, 0x0a,
    MP_QSTR_close & 0xff, MP_QSTR_close >> 8,
    MP_QSTR_uasyncio_slash_stream_dot_py & 0xff, MP_QSTR_uasyncio_slash_stream_dot_py >> 8,
    0x00,
...
STATIC byte fun_data_uasyncio_stream__lt_module_gt__Stream_wait_closed[21] = {
    0x91, 0x40, 0x0a,
    MP_QSTR_wait_closed & 0xff, MP_QSTR_wait_closed >> 8,
    MP_QSTR_uasyncio_slash_stream_dot_py & 0xff, MP_QSTR_uasyncio_slash_stream_dot_py >> 8,
    0x00,
    0xb0, 
    0x13, MP_QSTR_s & 0xff, MP_QSTR_s >> 8,  0x00,
    0x14, MP_QSTR_close & 0xff, MP_QSTR_close >> 8, 
    0x36, 0x00, 
    0x59, 
    0x51, 
...
STATIC byte fun_data_uasyncio_stream__lt_module_gt__Stream_read[40] = {
    0xa2, 0x40, 0x0a,
    MP_QSTR_read & 0xff, MP_QSTR_read >> 8,
    MP_QSTR_uasyncio_slash_stream_dot_py & 0xff, MP_QSTR_uasyncio_slash_stream_dot_py >> 8,
    0x00,
    0x12, MP_QSTR_core & 0xff, MP_QSTR_core >> 8,  0x00,
    0x13, MP_QSTR__io_queue & 0xff, MP_QSTR__io_queue >> 8,  0x00,
...
STATIC byte fun_data_uasyncio_stream__lt_module_gt__Stream_readexactly[88] = {
    0xb2, 0x40, 0x0a,
    ...
    0x34, 0x01, 
    0x43, 0x05, 0x80, 
    0x12, MP_QSTR_EOFError & 0xff, MP_QSTR_EOFError >> 8,  0x00,
    0x65, 
    0xb2, 
    0xb3, 
    0xe5, 
...
STATIC byte fun_data_uasyncio_stream__lt_module_gt__Stream_readline[65] = {
    0xa9, 0x40, 0x0a,
...
STATIC byte fun_data_uasyncio_stream__lt_module_gt__Stream_write[22] = {
    0x22, 0x0a,
    ...
    0xb0, 
    0x57, 
    0x13, MP_QSTR_out_buf & 0xff, MP_QSTR_out_buf >> 8,  0x00,
    0xb1, 
    0xe5, 
    0x5a, 
    0x18, MP_QSTR_out_buf & 0xff, MP_QSTR_out_buf >> 8,  0x00,
...
STATIC byte fun_data_uasyncio_stream__lt_module_gt__Stream_drain[94] = {
    0xc1, 0x40, 0x0a,
...
STATIC byte fun_data_uasyncio_stream__lt_module_gt__Stream[82] = {
    0x08, 0x0a,
...
STATIC byte fun_data_uasyncio_stream__lt_module_gt__open_connection[136] = {
    0xea, 0x42, 0x0a,
    ...
    0x36, 0x01, 
    0x59, 
    0x12, MP_QSTR_Stream & 0xff, MP_QSTR_Stream >> 8,  0x00,
    0xb5, 
    0x34, 0x01, 
    0xc6, 
    0x48, 0x0d, 0x00, 
...
STATIC byte fun_data_uasyncio_stream__lt_module_gt__Server___aenter__[10] = {
    0x89, 0x40, 0x0a,
    MP_QSTR___aenter__ & 0xff, MP_QSTR___aenter__ >> 8,
    MP_QSTR_uasyncio_slash_stream_dot_py & 0xff, MP_QSTR_uasyncio_slash_stream_dot_py >> 8,
    0x00,
...
STATIC byte fun_data_uasyncio_stream__lt_module_gt__Server___aexit__[27] = {
    0xa8, 0x44, 0x0a,
    MP_QSTR___aexit__ & 0xff, MP_QSTR___aexit__ >> 8,
    MP_QSTR_uasyncio_slash_stream_dot_py & 0xff, MP_QSTR_uasyncio_slash_stream_dot_py >> 8,
    0x00,
...
STATIC byte fun_data_uasyncio_stream__lt_module_gt__Server_close[20] = {
    0x11, 0x0a,
    MP_QSTR_close & 0xff, MP_QSTR_close >> 8,
    MP_QSTR_uasyncio_slash_stream_dot_py & 0xff, MP_QSTR_uasyncio_slash_stream_dot_py >> 8,
    0x00,
    0xb0, 
    0x13, MP_QSTR_task & 0xff, MP_QSTR_task >> 8,  0x00,
    0x14, MP_QSTR_cancel & 0xff, MP_QSTR_cancel >> 8, 
    0x36, 0x00, 
    0x59, 
    0x51, 
...
STATIC byte fun_data_uasyncio_stream__lt_module_gt__Server_wait_closed[19] = {
    0x91, 0x40, 0x0a,
    MP_QSTR_wait_closed & 0xff, MP_QSTR_wait_closed >> 8,
    MP_QSTR_uasyncio_slash_stream_dot_py & 0xff, MP_QSTR_uasyncio_slash_stream_dot_py >> 8,
    0x00,
...
STATIC byte fun_data_uasyncio_stream__lt_module_gt__Server__serve[206] = {
    0x85, 0x54, 0x0a,
    ...
    0xb5, 
    0x13, MP_QSTR_SOL_SOCKET & 0xff, MP_QSTR_SOL_SOCKET >> 8,  0x00,
    0xb5, 
    0x13, MP_QSTR_SO_REUSEADDR & 0xff, MP_QSTR_SO_REUSEADDR >> 8,  0x00,
    0x81, 
    0x36, 0x03, 
    0x59, 
    0xb7, 
    ...
    0x13, MP_QSTR_cur_task & 0xff, MP_QSTR_cur_task >> 8,  0x00,
    0xb0, 
    0x18, MP_QSTR_task & 0xff, MP_QSTR_task >> 8,  0x00,
    0x48, 0x13, 0x00, 
    0x12, MP_QSTR_core & 0xff, MP_QSTR_core >> 8,  0x00,
    0x13, MP_QSTR__io_queue & 0xff, MP_QSTR__io_queue >> 8,  0x00,
    0x14, MP_QSTR_queue_read & 0xff, MP_QSTR_queue_read >> 8, 
...
STATIC byte fun_data_uasyncio_stream__lt_module_gt__Server[47] = {
    0x00, 0x0a,
...
STATIC byte fun_data_uasyncio_stream__lt_module_gt__start_server[37] = {
    0xe0, 0x45, 0x0a,
    MP_QSTR_start_server & 0xff, MP_QSTR_start_server >> 8,
    MP_QSTR_uasyncio_slash_stream_dot_py & 0xff, MP_QSTR_uasyncio_slash_stream_dot_py >> 8,
    0x00,
    0x12, MP_QSTR_Server & 0xff, MP_QSTR_Server >> 8,  0x00,
    0x34, 0x00, 
    0xc4, 
    0x12, MP_QSTR_core & 0xff, MP_QSTR_core >> 8,  0x00,
    0x14, MP_QSTR_create_task & 0xff, MP_QSTR_create_task >> 8, 
...
STATIC byte fun_data_uasyncio_stream__lt_module_gt__stream_awrite[72] = {
    0xb8, 0xc4, 0x01, 0x0a,
...
STATIC byte fun_data_uasyncio_stream__lt_module_gt_[125] = {
    0x10, 0x0a,
    MP_QSTR__lt_module_gt_ & 0xff, MP_QSTR__lt_module_gt_ >> 8,
    MP_QSTR_uasyncio_slash_stream_dot_py & 0xff, MP_QSTR_uasyncio_slash_stream_dot_py >> 8,
    0x00,
    ...
    0x11, MP_QSTR_Stream & 0xff, MP_QSTR_Stream >> 8,  0x00,
    ...
    0x11, MP_QSTR_Stream & 0xff, MP_QSTR_Stream >> 8,  0x00,
    0x13, MP_QSTR_wait_closed & 0xff, MP_QSTR_wait_closed >> 8,  0x00,
    0x11, MP_QSTR_Stream & 0xff, MP_QSTR_Stream >> 8,  0x00,
    0x18, MP_QSTR_aclose & 0xff, MP_QSTR_aclose >> 8,  0x00,
    0x11, MP_QSTR_stream_awrite & 0xff, MP_QSTR_stream_awrite >> 8,  0x00,
    0x11, MP_QSTR_Stream & 0xff, MP_QSTR_Stream >> 8,  0x00,
    0x18, MP_QSTR_awrite & 0xff, MP_QSTR_awrite >> 8,  0x00,
    0x11, MP_QSTR_stream_awrite & 0xff, MP_QSTR_stream_awrite >> 8,  0x00,
    0x11, MP_QSTR_Stream & 0xff, MP_QSTR_Stream >> 8,  0x00,
    0x18, MP_QSTR_awritestr & 0xff, MP_QSTR_awritestr >> 8,  0x00,
    0x51, 
    0x63, 
};

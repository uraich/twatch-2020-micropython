...
QDEF(MP_QSTR_BG_SCRLLABLE, (const byte*)"\x37\x84\x0c" "BG_SCRLLABLE")
...
QDEF(MP_QSTR_align_origo_x, (const byte*)"\x0c\x89\x0d" "align_origo_x")
QDEF(MP_QSTR_align_origo_y, (const byte*)"\x0d\x89\x0d" "align_origo_y")
...
QDEF(MP_QSTR_fb, (const byte*)"\x41\x6e\x02" "fb")
QDEF(MP_QSTR_fbdev_flush, (const byte*)"\xcd\x93\x0b" "fbdev_flush")
...
QDEF(MP_QSTR_get_scrlbar_mode, (const byte*)"\xef\x48\x10" "get_scrlbar_mode")
...
QDEF(MP_QSTR_set_cell_value_fmt, (const byte*)"\x8a\x4e\x12" "set_cell_value_fmt")
...
QDEF(MP_QSTR_set_scrlbar_mode, (const byte*)"\x7b\xc7\x10" "set_scrlbar_mode")
...
QDEF(MP_QSTR_snprintf, (const byte*)"\x4f\xc7\x08" "snprintf")

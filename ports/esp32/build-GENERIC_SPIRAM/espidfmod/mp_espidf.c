 ...
 *
 * Command line:
 * ../../lib/lv_bindings/gen/gen_mpy.py -M espidf -E build-GENERIC_SPIRAM/espidfmod/mp_espidf.pp.c ../../lib/lv_bindings/driver/esp32/espidf.h
 *
...
STATIC inline mp_obj_t mp_lv_funcptr_http_event_handle_cb(void *fun){ return mp_lv_funcptr(&mp_funcptr_http_event_handle_cb_obj, fun); }
...
STATIC void mp_esp_http_client_config_t_attr(mp_obj_t self_in, qstr attr, mp_obj_t *dest)
{
    ...
    if (dest[0] == MP_OBJ_NULL) {
        ...
        switch(attr)
        {
            ...
            case MP_QSTR_event_handler: dest[0] = mp_lv_funcptr_http_event_handle_cb(data->event_handler); break; // converting from callback http_event_handle_cb;
...
STATIC inline mp_obj_t mp_lv_funcptr_gpio_intr_handler_fn_t(void *fun){ return mp_lv_funcptr(&mp_funcptr_gpio_intr_handler_fn_t_obj, fun); }
...
STATIC inline mp_obj_t mp_lv_funcptr_fn(void *fun){ return mp_lv_funcptr(&mp_funcptr_fn_obj, fun); }
...
STATIC inline mp_obj_t mp_lv_funcptr_ets_idle_cb_t(void *fun){ return mp_lv_funcptr(&mp_funcptr_ets_idle_cb_t_obj, fun); }
...
STATIC inline mp_obj_t mp_lv_funcptr_ETSTask(void *fun){ return mp_lv_funcptr(&mp_funcptr_ETSTask_obj, fun); }
...
STATIC inline mp_obj_t mp_lv_funcptr_p(void *fun){ return mp_lv_funcptr(&mp_funcptr_p_obj, fun); }
...
STATIC inline mp_obj_t mp_lv_funcptr_shutdown_handler_t(void *fun){ return mp_lv_funcptr(&mp_funcptr_shutdown_handler_t_obj, fun); }
...
STATIC inline mp_obj_t mp_lv_funcptr_dhcps_cb_t(void *fun){ return mp_lv_funcptr(&mp_funcptr_dhcps_cb_t_obj, fun); }
...
STATIC inline mp_obj_t mp_lv_funcptr_http_cb(void *fun){ return mp_lv_funcptr(&mp_funcptr_http_cb_obj, fun); }
...
STATIC inline mp_obj_t mp_lv_funcptr_http_data_cb(void *fun){ return mp_lv_funcptr(&mp_funcptr_http_data_cb_obj, fun); }
...
STATIC void mp_http_parser_settings_attr(mp_obj_t self_in, qstr attr, mp_obj_t *dest)
{
    ...
    if (dest[0] == MP_OBJ_NULL) {
        ...
        switch(attr)
        {
            case MP_QSTR_on_message_begin: dest[0] = mp_lv_funcptr_http_cb(data->on_message_begin); break; // converting from callback http_cb;
            case MP_QSTR_on_url: dest[0] = mp_lv_funcptr_http_data_cb(data->on_url); break; // converting from callback http_data_cb;
            case MP_QSTR_on_status: dest[0] = mp_lv_funcptr_http_data_cb(data->on_status); break; // converting from callback http_data_cb;
            case MP_QSTR_on_header_field: dest[0] = mp_lv_funcptr_http_data_cb(data->on_header_field); break; // converting from callback http_data_cb;
            case MP_QSTR_on_header_value: dest[0] = mp_lv_funcptr_http_data_cb(data->on_header_value); break; // converting from callback http_data_cb;
            case MP_QSTR_on_headers_complete: dest[0] = mp_lv_funcptr_http_cb(data->on_headers_complete); break; // converting from callback http_cb;
            case MP_QSTR_on_body: dest[0] = mp_lv_funcptr_http_data_cb(data->on_body); break; // converting from callback http_data_cb;
            case MP_QSTR_on_message_complete: dest[0] = mp_lv_funcptr_http_cb(data->on_message_complete); break; // converting from callback http_cb;
            case MP_QSTR_on_chunk_header: dest[0] = mp_lv_funcptr_http_cb(data->on_chunk_header); break; // converting from callback http_cb;
            case MP_QSTR_on_chunk_complete: dest[0] = mp_lv_funcptr_http_cb(data->on_chunk_complete); break; // converting from callback http_cb;
            default: call_parent_methods(self_in, attr, dest); // fallback to locals_dict lookup
        }
    } else {
        if (dest[1])
...
STATIC inline mp_obj_t mp_lv_funcptr_transaction_cb_t(void *fun){ return mp_lv_funcptr(&mp_funcptr_transaction_cb_t_obj, fun); }
...
STATIC void mp_spi_device_interface_config_t_attr(mp_obj_t self_in, qstr attr, mp_obj_t *dest)
{
    ...
    if (dest[0] == MP_OBJ_NULL) {
        ...
        switch(attr)
        {
            ...
            case MP_QSTR_pre_cb: dest[0] = mp_lv_funcptr_transaction_cb_t(data->pre_cb); break; // converting from callback transaction_cb_t;
            case MP_QSTR_post_cb: dest[0] = mp_lv_funcptr_transaction_cb_t(data->post_cb); break; // converting from callback transaction_cb_t;
            default: call_parent_methods(self_in, attr, dest); // fallback to locals_dict lookup
        }
    } else {
        if (dest[1])

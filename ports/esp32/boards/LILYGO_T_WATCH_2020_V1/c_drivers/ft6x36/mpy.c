...
/*
 * ft6x36 ENUM_LV_LOG_LEVEL object definitions
 */
...
STATIC void ENUM_LV_LOG_LEVEL_print(const mp_print_t *print,
    ...
    mp_print_kind_t kind)
{
    mp_printf(print, "ft6x36 ENUM_LV_LOG_LEVEL");
}
...
/*
 * ft6x36 LV_RES object definitions
 */
...
/*
 * ft6x36 ENUM_LV_COORD object definitions
 */
...
STATIC void ENUM_LV_COORD_print(const mp_print_t *print,
    ...
    mp_print_kind_t kind)
{
    mp_printf(print, "ft6x36 ENUM_LV_COORD");
}
...
/*
 * ft6x36 LV_ALIGN object definitions
 */
...
STATIC void LV_ALIGN_print(const mp_print_t *print,
    ...
    mp_print_kind_t kind)
{
    mp_printf(print, "ft6x36 LV_ALIGN");
}
...
/*
 * ft6x36 LV_TASK_PRIO object definitions
 */
...
STATIC void LV_TASK_PRIO_print(const mp_print_t *print,
    ...
    mp_print_kind_t kind)
{
    mp_printf(print, "ft6x36 LV_TASK_PRIO");
}
...
/*
 * ft6x36 LV_INDEV_TYPE object definitions
 */
...
STATIC void LV_INDEV_TYPE_print(const mp_print_t *print,
    ...
    mp_print_kind_t kind)
{
    mp_printf(print, "ft6x36 LV_INDEV_TYPE");
}
...
/*
 * ft6x36 LV_INDEV_STATE object definitions
 */
...
STATIC void LV_INDEV_STATE_print(const mp_print_t *print,
    ...
    mp_print_kind_t kind)
{
    mp_printf(print, "ft6x36 LV_INDEV_STATE");
}
...
/*
 * ft6x36 LV_DRAG_DIR object definitions
 */
...
STATIC void LV_DRAG_DIR_print(const mp_print_t *print,
    ...
    mp_print_kind_t kind)
{
    mp_printf(print, "ft6x36 LV_DRAG_DIR");
}
...
/*
 * ft6x36 LV_GESTURE_DIR object definitions
 */
...
STATIC void LV_GESTURE_DIR_print(const mp_print_t *print,
    ...
    mp_print_kind_t kind)
{
    mp_printf(print, "ft6x36 LV_GESTURE_DIR");
}
...
/*
 * ft6x36 LV_OPA object definitions
 */
...
/*
 * ft6x36 LV_DISP_SIZE object definitions
 */
...
STATIC void LV_DISP_SIZE_print(const mp_print_t *print,
    ...
    mp_print_kind_t kind)
{
    mp_printf(print, "ft6x36 LV_DISP_SIZE");
}
...
/*
 * ft6x36 extension definition for:
...
STATIC mp_obj_t mp_ft6x06_init(size_t mp_n_args, const mp_obj_t *mp_args)
{
    uint16_t dev_addr = (uint16_t)mp_obj_get_int(mp_args[0]);
    ft6x06_init(dev_addr);
    return mp_const_none;
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_ft6x06_init_obj, 1, mp_ft6x06_init, ft6x06_init);
...
STATIC mp_obj_t mp_ft6x36_get_gesture_id(size_t mp_n_args, const mp_obj_t *mp_args)
{
    
    uint8_t _res = ft6x36_get_gesture_id();
    return mp_obj_new_int_from_uint(_res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_ft6x36_get_gesture_id_obj, 0, mp_ft6x36_get_gesture_id, ft6x36_get_gesture_id);
...
STATIC mp_obj_t mp_ft6x36_read(size_t mp_n_args, const mp_obj_t *mp_args)
{
    lv_indev_drv_t *drv = mp_write_ptr_lv_indev_drv_t(mp_args[0]);
    lv_indev_data_t *data = mp_write_ptr_lv_indev_data_t(mp_args[1]);
    bool _res = ft6x36_read(drv, data);
    return convert_to_bool(_res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_ft6x36_read_obj, 2, mp_ft6x36_read, ft6x36_read);

 
/* List of structs: ['lv_indev_data_t'] */
/* Struct lv_indev_data_t contains: [] */
...
STATIC mp_obj_t mp_touch_driver_init(size_t mp_n_args, const mp_obj_t *mp_args)
{
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_touch_driver_init_obj, 0, mp_touch_driver_init, touch_driver_init);
...
STATIC mp_obj_t mp_touch_driver_read(size_t mp_n_args, const mp_obj_t *mp_args)
{
    lv_indev_drv_t *drv = mp_write_ptr_lv_indev_drv_t(mp_args[0]);
    lv_indev_data_t *data = mp_write_ptr_lv_indev_data_t(mp_args[1]);
    bool _res = touch_driver_read(drv, data);
    return convert_to_bool(_res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_touch_driver_read_obj, 2, mp_touch_driver_read, touch_driver_read);
...
STATIC mp_obj_t mp_lvgl_touch_init(size_t mp_n_args, const mp_obj_t *mp_args)
{
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lvgl_touch_init_obj, 0, mp_lvgl_touch_init, lvgl_touch_init);
...
STATIC mp_obj_t mp_lvgl_i2c_driver_init(size_t mp_n_args, const mp_obj_t *mp_args)
{
    int port = (int)mp_obj_get_int(mp_args[0]);
    int sda_pin = (int)mp_obj_get_int(mp_args[1]);
    int scl_pin = (int)mp_obj_get_int(mp_args[2]);
    int speed = (int)mp_obj_get_int(mp_args[3]);
    bool _res = lvgl_i2c_driver_init(port, sda_pin, scl_pin, speed);
    return convert_to_bool(_res);
}

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_lvgl_i2c_driver_init_obj, 4, mp_lvgl_i2c_driver_init, lvgl_i2c_driver_init);
...
/*
 * ft6x36 module definitions
 */

STATIC const mp_rom_map_elem_t ft6x36_globals_table[] = {
    { MP_ROM_QSTR(MP_QSTR___name__), MP_ROM_QSTR(MP_QSTR_ft6x36) },
    ...
    { MP_ROM_QSTR(MP_QSTR_ft6x06_init), MP_ROM_PTR(&mp_ft6x06_init_obj) },
    { MP_ROM_QSTR(MP_QSTR_get_gesture_id), MP_ROM_PTR(&mp_ft6x36_get_gesture_id_obj) },
    { MP_ROM_QSTR(MP_QSTR_read), MP_ROM_PTR(&mp_ft6x36_read_obj) },
    { MP_ROM_QSTR(MP_QSTR_touch_driver_init), MP_ROM_PTR(&mp_touch_driver_init_obj) },
    { MP_ROM_QSTR(MP_QSTR_touch_driver_read), MP_ROM_PTR(&mp_touch_driver_read_obj) },
    { MP_ROM_QSTR(MP_QSTR_lvgl_touch_init), MP_ROM_PTR(&mp_lvgl_touch_init_obj) },
    { MP_ROM_QSTR(MP_QSTR_lvgl_i2c_driver_init), MP_ROM_PTR(&mp_lvgl_i2c_driver_init_obj) },
...
STATIC MP_DEFINE_CONST_DICT (
    mp_module_ft6x36_globals,
    ft6x36_globals_table
);

const mp_obj_module_t mp_module_ft6x36 = {
    .base = { &mp_type_module },
    .globals = (mp_obj_dict_t*)&mp_module_ft6x36_globals
};
MP_REGISTER_MODULE(MP_QSTR_ft6x36, mp_module_ft6x36, 1);

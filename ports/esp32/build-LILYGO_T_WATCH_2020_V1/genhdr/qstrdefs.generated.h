...
QDEF(MP_QSTR_B24, (const byte*)"\xa1\xd1\x03" "B24")
QDEF(MP_QSTR_B32, (const byte*)"\x46\xd1\x03" "B32")
...
QDEF(MP_QSTR_DIRECTION_BOTTOM_EDGE, (const byte*)"\xec\x08\x15" "DIRECTION_BOTTOM_EDGE")
QDEF(MP_QSTR_DIRECTION_DISP_DOWN, (const byte*)"\xbc\x79\x13" "DIRECTION_DISP_DOWN")
QDEF(MP_QSTR_DIRECTION_DISP_UP, (const byte*)"\x6b\x9d\x11" "DIRECTION_DISP_UP")
QDEF(MP_QSTR_DIRECTION_LEFT_EDGE, (const byte*)"\x18\xdc\x13" "DIRECTION_LEFT_EDGE")
QDEF(MP_QSTR_DIRECTION_RIGHT_EDGE, (const byte*)"\x63\x6d\x14" "DIRECTION_RIGHT_EDGE")
QDEF(MP_QSTR_DIRECTION_TOP_EDGE, (const byte*)"\x08\x01\x12" "DIRECTION_TOP_EDGE")
...
QDEF(MP_QSTR_ETS, (const byte*)"\x67\xa8\x03" "ETS")
QDEF(MP_QSTR_ETSTimer, (const byte*)"\xc0\xaf\x08" "ETSTimer")
...
QDEF(MP_QSTR_FAILED, (const byte*)"\xc6\x60\x06" "FAILED")
...
QDEF(MP_QSTR_IRQ_DOUBLE_WAKEUP, (const byte*)"\x27\xff\x11" "IRQ_DOUBLE_WAKEUP")
QDEF(MP_QSTR_IRQ_FALLING, (const byte*)"\x37\xc0\x0b" "IRQ_FALLING")
QDEF(MP_QSTR_IRQ_INVALID, (const byte*)"\x41\x6b\x0b" "IRQ_INVALID")
QDEF(MP_QSTR_IRQ_RISING, (const byte*)"\x78\xed\x0a" "IRQ_RISING")
QDEF(MP_QSTR_IRQ_STEP_COUNTER, (const byte*)"\x69\x3f\x10" "IRQ_STEP_COUNTER")
...
QDEF(MP_QSTR_LV_COORD, (const byte*)"\x15\x6f\x08" "LV_COORD")
...
QDEF(MP_QSTR_LV_LOG_LEVEL, (const byte*)"\xad\x72\x0c" "LV_LOG_LEVEL")
...
QDEF(MP_QSTR_Loop, (const byte*)"\x19\xe9\x04" "Loop")
QDEF(MP_QSTR_MAIN, (const byte*)"\xce\xb7\x04" "MAIN")
...
QDEF(MP_QSTR_MASTER_RX, (const byte*)"\x4c\x47\x09" "MASTER_RX")
QDEF(MP_QSTR_MASTER_TX, (const byte*)"\x8a\x46\x09" "MASTER_TX")
...
QDEF(MP_QSTR_NUM0, (const byte*)"\xc3\xa8\x04" "NUM0")
QDEF(MP_QSTR_NUM1, (const byte*)"\xc2\xa8\x04" "NUM1")
...
QDEF(MP_QSTR_PDM_SAMPLE_RATE_RATIO, (const byte*)"\xe6\x97\x15" "PDM_SAMPLE_RATE_RATIO")
QDEF(MP_QSTR_PENDING, (const byte*)"\x9a\xae\x07" "PENDING")
QDEF(MP_QSTR_PERIODIC, (const byte*)"\x0a\x35\x08" "PERIODIC")
QDEF(MP_QSTR_PERIPH, (const byte*)"\x53\xa7\x06" "PERIPH")
QDEF(MP_QSTR_PHILIPS, (const byte*)"\xf2\x1b\x07" "PHILIPS")
...
QDEF(MP_QSTR_TCPIP_ADAPTER, (const byte*)"\xb3\x3f\x0d" "TCPIP_ADAPTER")
QDEF(MP_QSTR_TCPIP_ADAPTER_DHCP, (const byte*)"\xb3\x18\x12" "TCPIP_ADAPTER_DHCP")
QDEF(MP_QSTR_TCPIP_ADAPTER_DNS, (const byte*)"\xd5\x09\x11" "TCPIP_ADAPTER_DNS")
QDEF(MP_QSTR_TCPIP_ADAPTER_IF, (const byte*)"\x63\xf0\x10" "TCPIP_ADAPTER_IF")
QDEF(MP_QSTR_TCPIP_ADAPTER_OP, (const byte*)"\xb3\xef\x10" "TCPIP_ADAPTER_OP")
...
QDEF(MP_QSTR__128, (const byte*)"\x41\xe1\x04" "_128")
...
QDEF(MP_QSTR__64, (const byte*)"\xb8\x16\x03" "_64")
...
QDEF(MP_QSTR__exc_context, (const byte*)"\x24\x33\x0c" "_exc_context")
...
QDEF(MP_QSTR_apllrate, (const byte*)"\xf6\x02\x08" "apllrate")
...
QDEF(MP_QSTR_bma423, (const byte*)"\xbe\xd3\x06" "bma423")
...
QDEF(MP_QSTR_call_exception_handler, (const byte*)"\xe8\x4c\x16" "call_exception_handler")
...
QDEF(MP_QSTR_cb_finalizer, (const byte*)"\x73\x8f\x0c" "cb_finalizer")
...
QDEF(MP_QSTR_channelformat, (const byte*)"\x05\x2b\x0d" "channelformat")
...
QDEF(MP_QSTR_dataformat, (const byte*)"\x36\x7a\x0a" "dataformat")
...
QDEF(MP_QSTR_del, (const byte*)"\x68\x1e\x03" "del")
...
QDEF(MP_QSTR_dmacount, (const byte*)"\x4e\x45\x08" "dmacount")
QDEF(MP_QSTR_dmalen, (const byte*)"\x0a\xf6\x06" "dmalen")
...
QDEF(MP_QSTR_driver_flush, (const byte*)"\xa0\xa3\x0c" "driver_flush")
QDEF(MP_QSTR_driver_init, (const byte*)"\x3e\xb3\x0b" "driver_init")
...
QDEF(MP_QSTR_esp_intr_alloc, (const byte*)"\xcf\xb5\x0e" "esp_intr_alloc")
QDEF(MP_QSTR_esp_intr_alloc_intrstatus, (const byte*)"\xa5\x19\x19" "esp_intr_alloc_intrstatus")
QDEF(MP_QSTR_esp_intr_disable, (const byte*)"\xb6\xa1\x10" "esp_intr_disable")
QDEF(MP_QSTR_esp_intr_enable, (const byte*)"\xc3\xee\x0f" "esp_intr_enable")
QDEF(MP_QSTR_esp_intr_free, (const byte*)"\xf6\x36\x0d" "esp_intr_free")
QDEF(MP_QSTR_esp_intr_get_cpu, (const byte*)"\x4d\xd6\x10" "esp_intr_get_cpu")
QDEF(MP_QSTR_esp_intr_get_intno, (const byte*)"\x59\x3e\x12" "esp_intr_get_intno")
QDEF(MP_QSTR_esp_intr_mark_shared, (const byte*)"\x21\xe9\x14" "esp_intr_mark_shared")
QDEF(MP_QSTR_esp_intr_noniram_disable, (const byte*)"\x11\x46\x18" "esp_intr_noniram_disable")
QDEF(MP_QSTR_esp_intr_noniram_enable, (const byte*)"\x84\xbd\x17" "esp_intr_noniram_enable")
QDEF(MP_QSTR_esp_intr_reserve, (const byte*)"\x62\x82\x10" "esp_intr_reserve")
QDEF(MP_QSTR_esp_intr_set_in_iram, (const byte*)"\x30\xfa\x14" "esp_intr_set_in_iram")
...
QDEF(MP_QSTR_ets_delay_us, (const byte*)"\xd4\x95\x0c" "ets_delay_us")
QDEF(MP_QSTR_ets_get_cpu_frequency, (const byte*)"\x4c\x21\x15" "ets_get_cpu_frequency")
QDEF(MP_QSTR_ets_get_detected_xtal_freq, (const byte*)"\x76\x9b\x1a" "ets_get_detected_xtal_freq")
QDEF(MP_QSTR_ets_get_xtal_scale, (const byte*)"\xb7\x9a\x12" "ets_get_xtal_scale")
QDEF(MP_QSTR_ets_install_putc1, (const byte*)"\x05\xb4\x11" "ets_install_putc1")
QDEF(MP_QSTR_ets_install_putc2, (const byte*)"\x06\xb4\x11" "ets_install_putc2")
QDEF(MP_QSTR_ets_install_uart_printf, (const byte*)"\xbc\x3f\x17" "ets_install_uart_printf")
QDEF(MP_QSTR_ets_intr_lock, (const byte*)"\x0d\x3d\x0d" "ets_intr_lock")
QDEF(MP_QSTR_ets_intr_unlock, (const byte*)"\xb6\x7d\x0f" "ets_intr_unlock")
QDEF(MP_QSTR_ets_isr_attach, (const byte*)"\xa4\xf5\x0e" "ets_isr_attach")
QDEF(MP_QSTR_ets_isr_mask, (const byte*)"\xbb\x59\x0c" "ets_isr_mask")
QDEF(MP_QSTR_ets_isr_unmask, (const byte*)"\x40\x2c\x0e" "ets_isr_unmask")
QDEF(MP_QSTR_ets_post, (const byte*)"\xc0\xd0\x08" "ets_post")
QDEF(MP_QSTR_ets_run, (const byte*)"\x71\x85\x07" "ets_run")
QDEF(MP_QSTR_ets_set_appcpu_boot_addr, (const byte*)"\x27\xbe\x18" "ets_set_appcpu_boot_addr")
QDEF(MP_QSTR_ets_set_idle_cb, (const byte*)"\x5f\x40\x0f" "ets_set_idle_cb")
QDEF(MP_QSTR_ets_set_startup_callback, (const byte*)"\x96\xfe\x18" "ets_set_startup_callback")
QDEF(MP_QSTR_ets_set_user_start, (const byte*)"\x2b\x64\x12" "ets_set_user_start")
QDEF(MP_QSTR_ets_task, (const byte*)"\xd5\x1b\x08" "ets_task")
QDEF(MP_QSTR_ets_timer_arm, (const byte*)"\xde\x0b\x0d" "ets_timer_arm")
QDEF(MP_QSTR_ets_timer_arm_us, (const byte*)"\x67\x72\x10" "ets_timer_arm_us")
QDEF(MP_QSTR_ets_timer_deinit, (const byte*)"\xfb\xc1\x10" "ets_timer_deinit")
QDEF(MP_QSTR_ets_timer_disarm, (const byte*)"\x00\x95\x10" "ets_timer_disarm")
QDEF(MP_QSTR_ets_timer_done, (const byte*)"\xa0\x03\x0e" "ets_timer_done")
QDEF(MP_QSTR_ets_timer_init, (const byte*)"\x7a\x95\x0e" "ets_timer_init")
QDEF(MP_QSTR_ets_timer_setfn, (const byte*)"\x6a\x2a\x0f" "ets_timer_setfn")
QDEF(MP_QSTR_ets_unpack_flash_code, (const byte*)"\x87\x6f\x15" "ets_unpack_flash_code")
QDEF(MP_QSTR_ets_unpack_flash_code_legacy, (const byte*)"\x6d\x53\x1c" "ets_unpack_flash_code_legacy")
QDEF(MP_QSTR_ets_update_cpu_frequency, (const byte*)"\x2b\x80\x18" "ets_update_cpu_frequency")
QDEF(MP_QSTR_ets_update_cpu_frequency_rom, (const byte*)"\xc4\xd5\x1c" "ets_update_cpu_frequency_rom")
QDEF(MP_QSTR_ets_waiti0, (const byte*)"\xca\x59\x0a" "ets_waiti0")
QDEF(MP_QSTR_ets_write_char_uart, (const byte*)"\x4f\x74\x13" "ets_write_char_uart")
...
QDEF(MP_QSTR_ft6x06_init, (const byte*)"\x7a\x39\x0b" "ft6x06_init")
QDEF(MP_QSTR_ft6x36, (const byte*)"\xbc\x0d\x06" "ft6x36")
QDEF(MP_QSTR_full, (const byte*)"\xd6\x68\x04" "full")
QDEF(MP_QSTR_function, (const byte*)"\x27\x02\x08" "function")
QDEF(MP_QSTR_future, (const byte*)"\x00\x39\x06" "future")
...
QDEF(MP_QSTR_get_gesture_id, (const byte*)"\x19\x5f\x0e" "get_gesture_id")
...
QDEF(MP_QSTR_http_event_handler, (const byte*)"\x89\x45\x12" "http_event_handler")
...
QDEF(MP_QSTR_ili9431_flush, (const byte*)"\xfd\xcf\x0d" "ili9431_flush")
...
QDEF(MP_QSTR_intr_matrix_set, (const byte*)"\x1d\x42\x0f" "intr_matrix_set")
...
QDEF(MP_QSTR_ir, (const byte*)"\x3e\x6f\x02" "ir")
...
QDEF(MP_QSTR_lv_color_hex, (const byte*)"\xf7\x3c\x0c" "lv_color_hex")
QDEF(MP_QSTR_lv_color_hex3, (const byte*)"\xe4\xdb\x0d" "lv_color_hex3")
QDEF(MP_QSTR_lv_color_hsv_t, (const byte*)"\xa4\x6d\x0e" "lv_color_hsv_t")
QDEF(MP_QSTR_lv_color_hsv_to_rgb, (const byte*)"\xa3\x7e\x13" "lv_color_hsv_to_rgb")
QDEF(MP_QSTR_lv_color_make, (const byte*)"\x20\x5d\x0d" "lv_color_make")
QDEF(MP_QSTR_lv_color_mix_premult, (const byte*)"\xc6\x5e\x14" "lv_color_mix_premult")
QDEF(MP_QSTR_lv_color_rgb_to_hsv, (const byte*)"\xe3\xed\x13" "lv_color_rgb_to_hsv")
QDEF(MP_QSTR_lv_color_t, (const byte*)"\x96\xb5\x0a" "lv_color_t")
...
QDEF(MP_QSTR_lv_disp_get_default, (const byte*)"\xb3\x64\x13" "lv_disp_get_default")
...
QDEF(MP_QSTR_lv_log_register_print_cb, (const byte*)"\x22\x4e\x18" "lv_log_register_print_cb")
QDEF(MP_QSTR_lv_mem_alloc, (const byte*)"\xd7\x45\x0c" "lv_mem_alloc")
QDEF(MP_QSTR_lv_mem_defrag, (const byte*)"\x29\x43\x0d" "lv_mem_defrag")
QDEF(MP_QSTR_lv_mem_free, (const byte*)"\xee\x9f\x0b" "lv_mem_free")
QDEF(MP_QSTR_lv_mem_monitor_t, (const byte*)"\xdd\x1f\x10" "lv_mem_monitor_t")
QDEF(MP_QSTR_lv_mem_realloc, (const byte*)"\x60\xa3\x0e" "lv_mem_realloc")
QDEF(MP_QSTR_lv_mem_test, (const byte*)"\xac\x4b\x0b" "lv_mem_test")
...
QDEF(MP_QSTR_lv_task_create, (const byte*)"\xb6\x79\x0e" "lv_task_create")
QDEF(MP_QSTR_lv_task_create_basic, (const byte*)"\x73\x25\x14" "lv_task_create_basic")
QDEF(MP_QSTR_lv_task_enable, (const byte*)"\x73\x1f\x0e" "lv_task_enable")
QDEF(MP_QSTR_lv_task_get_idle, (const byte*)"\x5f\xf5\x10" "lv_task_get_idle")
QDEF(MP_QSTR_lv_task_handler, (const byte*)"\xca\x11\x0f" "lv_task_handler")
...
QDEF(MP_QSTR_lv_tick_elaps, (const byte*)"\x41\x89\x0d" "lv_tick_elaps")
QDEF(MP_QSTR_lv_tick_get, (const byte*)"\x7c\xca\x0b" "lv_tick_get")
QDEF(MP_QSTR_lv_tick_inc, (const byte*)"\x8e\xb1\x0b" "lv_tick_inc")
QDEF(MP_QSTR_lvesp32, (const byte*)"\x98\x9e\x07" "lvesp32")
QDEF(MP_QSTR_lvgl, (const byte*)"\x74\x85\x04" "lvgl")
QDEF(MP_QSTR_lvgl_driver_init, (const byte*)"\x10\x31\x10" "lvgl_driver_init")
QDEF(MP_QSTR_lvgl_i2c_driver_init, (const byte*)"\x17\xc8\x14" "lvgl_i2c_driver_init")
QDEF(MP_QSTR_lvgl_spi_driver_init, (const byte*)"\x85\x02\x14" "lvgl_spi_driver_init")
QDEF(MP_QSTR_lvgl_touch_init, (const byte*)"\xab\x25\x0f" "lvgl_touch_init")
...
QDEF(MP_QSTR_mhz, (const byte*)"\xda\x42\x03" "mhz")
...
QDEF(MP_QSTR_periph_module_disable, (const byte*)"\x5d\xef\x15" "periph_module_disable")
QDEF(MP_QSTR_periph_module_enable, (const byte*)"\xc8\xdd\x14" "periph_module_enable")
QDEF(MP_QSTR_periph_module_reset, (const byte*)"\xdc\x3e\x13" "periph_module_reset")
...
QDEF(MP_QSTR_read_irq, (const byte*)"\x62\x34\x08" "read_irq")
...
QDEF(MP_QSTR_rmtlib_nec_send, (const byte*)"\x3d\xde\x0f" "rmtlib_nec_send")
QDEF(MP_QSTR_rmtlib_rc5_send, (const byte*)"\xb1\xaa\x0f" "rmtlib_rc5_send")
QDEF(MP_QSTR_rmtlib_samsung_send, (const byte*)"\x05\xab\x13" "rmtlib_samsung_send")
...
QDEF(MP_QSTR_rst, (const byte*)"\x30\x89\x03" "rst")
...
QDEF(MP_QSTR_sdin, (const byte*)"\xd5\x7a\x04" "sdin")
QDEF(MP_QSTR_sdout, (const byte*)"\xfc\xcb\x05" "sdout")
...
QDEF(MP_QSTR_st7789_enable_backlight, (const byte*)"\xd7\xdc\x17" "st7789_enable_backlight")
QDEF(MP_QSTR_st7789_flush, (const byte*)"\xb8\x73\x0c" "st7789_flush")
QDEF(MP_QSTR_st7789_init, (const byte*)"\x26\x66\x0b" "st7789_init")
QDEF(MP_QSTR_st7789_lvgl, (const byte*)"\x4d\x75\x0b" "st7789_lvgl")
QDEF(MP_QSTR_st7789_send_cmd, (const byte*)"\x35\xf4\x0f" "st7789_send_cmd")
QDEF(MP_QSTR_st7789_set_orientation, (const byte*)"\x77\xa6\x16" "st7789_set_orientation")
...
QDEF(MP_QSTR_standard, (const byte*)"\x1e\x00\x08" "standard")
...
QDEF(MP_QSTR_stepcount, (const byte*)"\x34\x39\x09" "stepcount")
...
QDEF(MP_QSTR_tcpip_adapter_dns_info_t, (const byte*)"\x6f\xb3\x18" "tcpip_adapter_dns_info_t")
...
QDEF(MP_QSTR_tcpip_adapter_sta_info_t, (const byte*)"\x50\xaa\x18" "tcpip_adapter_sta_info_t")
QDEF(MP_QSTR_tcpip_adapter_sta_input, (const byte*)"\xc3\xbb\x17" "tcpip_adapter_sta_input")
QDEF(MP_QSTR_tcpip_adapter_sta_list_t, (const byte*)"\x9c\x3f\x18" "tcpip_adapter_sta_list_t")
...
QDEF(MP_QSTR_tcpip_adapter_test_start, (const byte*)"\x65\x1a\x18" "tcpip_adapter_test_start")
...
QDEF(MP_QSTR_timer_arg, (const byte*)"\x09\x24\x09" "timer_arg")
QDEF(MP_QSTR_timer_expire, (const byte*)"\xee\x48\x0c" "timer_expire")
QDEF(MP_QSTR_timer_func, (const byte*)"\x83\x44\x0a" "timer_func")
QDEF(MP_QSTR_timer_next, (const byte*)"\xda\x26\x0a" "timer_next")
QDEF(MP_QSTR_timer_period, (const byte*)"\x38\x43\x0c" "timer_period")
...
QDEF(MP_QSTR_touch_driver_init, (const byte*)"\xa4\x0e\x11" "touch_driver_init")
QDEF(MP_QSTR_touch_driver_read, (const byte*)"\x0c\x2b\x11" "touch_driver_read")
...
QDEF(MP_QSTR_x_inv, (const byte*)"\xd3\xf6\x05" "x_inv")
QDEF(MP_QSTR_x_max, (const byte*)"\x36\x08\x05" "x_max")
QDEF(MP_QSTR_x_min, (const byte*)"\x28\x07\x05" "x_min")
QDEF(MP_QSTR_xm, (const byte*)"\x10\x71\x02" "xm")
QDEF(MP_QSTR_xp, (const byte*)"\x0d\x71\x02" "xp")
QDEF(MP_QSTR_xpt2046, (const byte*)"\x19\xd4\x07" "xpt2046")
QDEF(MP_QSTR_xpt2046_read, (const byte*)"\xd4\x3a\x0c" "xpt2046_read")
QDEF(MP_QSTR_xt_clock_freq, (const byte*)"\xc1\xde\x0d" "xt_clock_freq")
QDEF(MP_QSTR_xy_steep, (const byte*)"\x6c\x0c\x08" "xy_steep")
QDEF(MP_QSTR_xy_swap, (const byte*)"\x4e\x0e\x07" "xy_swap")
...
QDEF(MP_QSTR_y_inv, (const byte*)"\xd2\xf6\x05" "y_inv")
QDEF(MP_QSTR_y_max, (const byte*)"\xf7\x08\x05" "y_max")
QDEF(MP_QSTR_y_min, (const byte*)"\xe9\x07\x05" "y_min")
